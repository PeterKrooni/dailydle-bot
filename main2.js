...
client.on(Events.InteractionCreate, async interaction => {
  ...
  switch(interaction.commandName) {
    case 'dailydle':
        await interaction.reply('Registered ' + interaction + ' on user ' + interaction.member?.displayName)
    case 'ping':
        interaction.
        console.info(interaction)
        await interaction.reply('Registered ' + interaction.command + ' on user ' + interaction.member?.displayName)
    case 'list':
